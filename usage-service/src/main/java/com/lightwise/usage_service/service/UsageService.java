...
import com.lightwise.usage_service.dto.UsageDto;
import com.lightwise.usage_service.dto.UserDto;
import com.lightwise.usage_service.model.Device;
...
public class UsageService {
  ...
  public UsageDto getXDaysUsageForUser(Long userId, int days) {
      ...
      for (FluxTable table : tables) {
        for (FluxRecord record : table.getRecords()) {
          ...
          try {
            ...
            aggregatedMap.put(deviceId, aggregatedMap.getOrDefault(energyConsumed, 0.0));
    ...
    log.info("Aggregated energy comsumption for userId {} : {}", userId, aggregatedMap);
